...
// Create a transporter for email notifications (Using Ethereal or a real service like Gmail)
// For this demo, we'll use a placeholder setup. 
// USER should replace with real credentials.
// Configure your real Gmail credentials here or in .env
// IMPORTANT: Use an "App Password" from your Google Account settings, not your regular password!
...
const updateOrderStatus = async (req, res) => {
  try {
    ...
    if (orderStatus === "delivered" && customerEmail) {
      const mailOptions = {
        from: '"Mediformers Pharmacy" <orders@mediformers.com>',
        to: customerEmail,
      ...
      transporter.sendMail(mailOptions).catch(err => console.error("Delivery Email Error:", err));
    }
