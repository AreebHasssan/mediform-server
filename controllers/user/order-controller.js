...
const createOrder = async (req, res) => {
  try {
    ...
    const adminMailOptions = {
      from: '"Mediformers Notifications" <noreply@mediformers.com>',
      to: process.env.EMAIL_USER || "your-email@gmail.com", // Admin receives this
    ...
    const userMailOptions = {
      ...
      to: addressInfo.email, // Use the email entered in the checkout form
      ...
      html: `
        <div style="font-family: sans-serif; max-width: 600px; margin: auto; border: 1px solid #eee; padding: 20px; border-radius: 10px;">
          ...
          <div style="margin-top: 20px; text-align: right;">
            <p style="font-size: 18px; font-bold;">Total Amount: <span style="color: #0d9488;">₹${totalAmount}</span></p>
          </div>
